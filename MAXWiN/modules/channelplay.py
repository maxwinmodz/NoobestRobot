...
from MAXWiN.modules.play import generate_cover
from MAXWiN.modules.play import arq
from MAXWiN.modules.play import cb_admin_check
from MAXWiN.modules.play import transcode
from MAXWiN.modules.play import convert_seconds
from MAXWiN.modules.play import time_to_seconds
from MAXWiN.modules.play import changeImageSize
from MAXWiN.config import BOT_NAME as bn
from MAXWiN.config import DURATION_LIMIT
from MAXWiN.config import UPDATES_CHANNEL as updateschannel
from MAXWiN.config import que
from MAXWiN.function.admins import admins as a
from MAXWiN.helpers.errors import DurationLimitError
from MAXWiN.helpers.decorators import errors
from MAXWiN.helpers.admins import get_administrators
from MAXWiN.helpers.channelmusic import get_chat_id
from MAXWiN.helpers.decorators import authorized_users_only
from MAXWiN.helpers.filters import command
from MAXWiN.helpers.filters import other_filters
from MAXWiN.helpers.gets import get_file_name
from MAXWiN.services.callsmusic import callsmusic
from MAXWiN.services.callsmusic import client as USER
from MAXWiN.services.converter.converter import convert
from MAXWiN.services.downloaders import youtube
from MAXWiN.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @MAXWiN to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
